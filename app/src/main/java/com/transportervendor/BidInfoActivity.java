...
import com.transportervendor.Api.BidService;
import com.transportervendor.Api.UserService;
import com.transportervendor.Bean.Bid;
    ...
    protected void onStart() {
        ...
        binding.btnbidnow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (NetworkUtility.checkInternetConnection(BidInfoActivity.this)) {
                    finish();
                    final CustomProgressDialog pd=new CustomProgressDialog(BidInfoActivity.this,"Please wait...");
                    pd.show();
